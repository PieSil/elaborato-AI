...
meanTimesPC = percentageChange(len(sizes), unweightedMeanTimes, weightedMeanTimes) # numpy.mean(timesPercentageChange)
meanStepsPC = percentageChange(len(sizes), unweightedMeanSteps, weightedMeanSteps) # numpy.mean(stepsPercentageChange)
